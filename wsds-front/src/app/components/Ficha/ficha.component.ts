  ...
  ngOnInit(): void {
    ...
    this.fichaForm = this.fb.group({
      description: [
        {
          value:
            'La noticia describe un homicidio, ya que contiene las palabras clave "homicidio" y "feminicidio".',
          disabled: true,
        },
      ],
      ...
      title: [
        {
          value:
            'Detienen a sujeto por golpear e intentar matar a su pareja con un cuchillo',
          disabled: true,
        },
      ],
      summary: [
        {
          value:
            'La policía detuvo a un hombre por presuntamente intentar asesinar a su compañera de vida con un cuchillo.',
          disabled: true,
        },
      ],
      location_of_incident: [
        { value: 'No se especifica en la noticia.', disabled: true },
      ],
      sources: [{ value: 'No se indican en la noticia.', disabled: true }],
      themes: [
        { value: 'Violencia contra las mujeres, feminicidio', disabled: true },
      ],
      violative_facts: [
        {
          value:
            'El hombre golpeó a su mujer y posteriormente intento asesinarla con un cuchillo.',
          disabled: true,
        },
      ],
      hypothesis_of_facts: [
      ...
      victims: [
        { value: 'La víctima no se identifica en la noticia.', disabled: true },
      ],
      perpetrator_or_suspected_aggressor: [
        {
          value:
            'El hombre que perpetró el homicidio no se identifica en la noticia',
          disabled: true,
        },
      ],
    });
